...
Replace your existing script.js with this updated version and test if the search feature works as expected.

How scrolling and loading/unloading works with the mobile app of Pokemon Home, is it possible to make this like that?
2 references
To implement scrolling and dynamic loading/unloading similar to the mobile app of Pokemon Home, we can improve the current implementation by adding lazy loading and unloading of elements.

Here is an updated version of your script.js file:
...
const pokemonList = [
    // Your existing list of Pokémon objects
];
